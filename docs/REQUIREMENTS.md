...
- **REQ-020**: MUST require prompt instructions that generate shell commands to emit only linear commands compatible with restrictive filtering systems and MUST NOT use command substitution (`$()` or backticks), complex variable expansion, nested substitution, shell-derived helpers, nested shell logic, or nested pipelines.
