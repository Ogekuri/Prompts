...
- **CHG-STP-006**: MUST define Step 6 to instruct: Generate Verification Delta by auditing ALL requirements with progressive-disclosure evidence (OK pointer-only, FAIL full), then verifying static-analysis results and implementing needed bug fixes.
...
- **COV-STP-005**: MUST define Step 5 to instruct: Generate Verification Delta by running static analysis (`req --here --static-check`) and implementing needed bug fixes.
...
- **FIX-CTX-002**: MUST define the `## Scope` section to instruct: In scope: reproduce/triage defects with concrete evidence, implement the smallest safe fix under %%SRC_PATHS%%, verify with requirement evidence plus `req --here --static-check`, then update `%%DOC_PATH%%/WORKFLOW.md` and `%%DOC_PATH%%/REFERENCES.md`, and commit; Out of scope: editing requirements, adding new features, or unnecessary refactors.
...
- **FIX-STP-004**: MUST define Step 4 to instruct: Read requirements, analyze defect evidence, and implement the smallest safe fix.
- **FIX-STP-005**: MUST define Step 5 to instruct: Generate Verification Delta by auditing ALL requirements with progressive-disclosure evidence (OK pointer-only, FAIL full), then verifying defect resolution with requirement evidence plus `req --here --static-check`.
...
- **IMP-STP-004**: MUST define Step 4 to instruct: Generate Verification Delta by running static analysis (`req --here --static-check`) and implementing needed bug fixes.
...
- **NEW-STP-006**: MUST define Step 6 to instruct: Generate Verification Delta by auditing ALL requirements with progressive-disclosure evidence (OK pointer-only, FAIL full), then verifying static-analysis results and implementing needed bug fixes.
...
- **RFR-STP-005**: MUST define Step 5 to instruct: Generate Verification Delta by running static analysis (`req --here --static-check`) and implementing needed bug fixes.
