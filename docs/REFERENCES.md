...
- `docs/WORKFLOW.md`: Updated `PROC:main` lifecycle behavior to encode exclusive worktree-delete cleanup and explicit prohibition of rollback/revert git-state commands in post-create early termination branches.
